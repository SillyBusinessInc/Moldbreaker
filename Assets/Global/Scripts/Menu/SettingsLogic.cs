...
public class SettingsLogic : MonoBehaviour
{
    ...
    public void OnResolutionChange(int optionIndex)
    {
        GlobalReference.Settings.Set("resolution", optionIndex);   // save resolution data     
        string selectedOption = resolutionDropdown.options[optionIndex].text;
